          ...
          <div class="container-fluid">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-12">
                      <div class="card">
                          <div class="card-body">
                              <form class="row g-2 needs-validation" novalidate="" method="post" action="<?=base_url()?>pengeluaran/simpan-data">
                                  <!-- Tanggal Transaksi -->
                                  ...
                                  <!-- Submit -->
                                  <div class="col-md-12 position-relative">
                                      <button class="btn btn-primary" id="tambah" type="submit">Tambah Pengeluaran</button>
                                  </div>
                              </form>
                          </div>
                      </div>
              ...
              <!-- End Form Tambah Pengeluaran-->
              <!-- Data Listing Pengeluaran -->
              <div class="row">
                  <div class="col-sm-12">
                      <div class="card">
                        <div class="card-header pb-0 card-no-border">
                          <h4>List Data Pengeluaran</h4>
                        </div>
                        <div class="card-body">
                          <div class="table-responsive">
                            <table class="display" id="table-finance-pengeluaran">
                              <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>TANGGAL</th>
              ...
              <!-- End Listing Pengeluaran -->
              <!-- Modal Edit Pengeluaran -->
              <div class="modal fade" id="EditFinancePengeluaranModal" tabindex="-1" role="dialog" aria-labelledby="EditFinancePengeluaranModal" aria-hidden="true">
