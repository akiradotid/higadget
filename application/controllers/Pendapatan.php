...
class Pendapatan extends Auth
{
  ...
  public function index()
  {
    ...
    $data['content'] = $this->load->view('finance/pendapatan', $data, true);
    $data['modal'] = '';
    $data['css'] = '
    ...
    <script src="' . base_url('assets/js/additional-js/pendapatan.js') . '"></script>
  ...
  public function updatepost(){
    if ($this->input->is_ajax_request()) {
      ...
      $data = [
        ...
        'id_finance_kategori'   => $this->input->post('ekategori'),
  ...
  public function jsonfnp(){
    ...
    $this->datatables->where('fk.tipe', 'Pendapatan');
