...
$route['master-finance-akun']='MasterFinanceAkun';
$route['master-finance-akun/jsonfna']='MasterFinanceAkun/jsonfna';
$route['master-finance-akun/loadfna']='MasterFinanceAkun/loadfna';
$route['master-finance-akun/simpan-data']='MasterFinanceAkun/createpost';
$route['master-finance-akun/update-data']='MasterFinanceAkun/updatepost';
$route['master-finance-akun/hapus/(:any)'] = 'MasterFinanceAkun/deletepost/$1';
$route['master-finance-akun/edit/(:any)'] = 'MasterFinanceAkun/edit/$1';

$route['master-finance-kategori']='MasterFinanceKategori';
$route['master-finance-kategori/loadfnk']='MasterFinanceKategori/loadfnk';
$route['master-finance-kategori/jsonfnk']='MasterFinanceKategori/jsonfnk';
$route['master-finance-kategori/simpan-data']='MasterFinanceKategori/createpost';
$route['master-finance-kategori/update-data']='MasterFinanceKategori/updatepost';
$route['master-finance-kategori/hapus/(:any)'] = 'MasterFinanceKategori/deletepost/$1';
$route['master-finance-kategori/edit/(:any)'] = 'MasterFinanceKategori/edit/$1';

$route['pendapatan']='Pendapatan';
$route['pendapatan/jsonfnp']='Pendapatan/jsonfnp';
$route['pendapatan/simpan-data']='Pendapatan/createpost';
$route['pendapatan/update-data']='Pendapatan/updatepost';
$route['pendapatan/hapus/(:any)'] = 'Pendapatan/deletepost/$1';
$route['pendapatan/edit/(:any)'] = 'Pendapatan/edit/$1';

$route['pengeluaran']='Pengeluaran';
$route['pengeluaran/jsonfnk']='Pengeluaran/jsonfnk';
$route['pengeluaran/simpan-data']='Pengeluaran/createpost';
$route['pengeluaran/update-data']='Pengeluaran/updatepost';
...
$route['laporan-buku-besar']='LaporanKeuangan/bukubesar';
$route['laporan-laba-rugi']='LaporanKeuangan/labarugi';
$route['laporan-arus-kas']='LaporanKeuangan/aruskas';
$route['laporan-inventaris']='LaporanKeuangan/inventaris';
...
$route['pembelian-input/simpan-acc']='PembelianInput/addacc';
$route['pembelian-input/hapus/(:num)'] = 'PembelianInput/deletepost/$1';
...
$route['produk-list/export-barcode-v2/(:any)/(:any)/(:any)/(:any)'] = 'PenList/exportbarcodev2/$1/$2/$3/$4';
$route['produk-list/export-barcode-select-v2/(:any)/(:any)/(:any)'] = 'PenList/exportbarcodev2/$1/$2/$3';
...
$route['dashboard-karyawan'] = 'DashboardKar';
