...
function table_etalase() {
    ...
    var ajaxConfig = {
        type: "POST",
        url: base_url + 'pembayaran/loadproduk/',
        data: function(d) {
                ...
                },
                {
                    ...
                    "action": function () {
                        ...
                        if (checkedData.length==0){
                            ...
                            $.ajax({
                                url: base_url + 'pembayaran/terima_data',
                                type: 'POST',
                                dataType: 'json',
    ...
    $('#generate').on('click', function() {
        ...
        if (noFaktur) {
            $.ajax({
                url: base_url + 'pembayaran/get_faktur', // File PHP untuk mengambil data
                type: 'POST',
                data: { no_faktur: noFaktur },
                dataType: 'json',
                success: function(response) {
                    if (response.success) {
                        $('#namasupplier').val(response.nama_plg); // Isi kolom nama_supp
    ...
    $(document).on("click", ".btn-refresh", function () {
        ...
        swal({
            ...
            if (keterangan) {
                $.ajax({
                    url: base_url + "pembayaran/unpostData",
                    type: "POST",
    ...
    $(document).on("click", ".btn-edit", function () {
        ...
        window.location.href = base_url + "pembayaran/edit_pembayaran/" + id ;
    });
    ...
    $("#editBayarForm").on("submit", function (e) {
        ...
        $.ajax({
            url: base_url + "pembayaran/updateBayar", // Ganti dengan URL Controller Anda
            type: "POST",
    ...
    $(document).on("click", ".btn-delete", function () {
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: base_url+ "pembayaran/deleteData", // Ganti dengan URL Controller Anda
                    type: "POST",
                    data: { id: id },
                    success: function (response) {
                        swal({
    ...
    $('#post').on('click', function () {
        ...
        $.ajax({
            url: base_url + 'pembayaran/posting',
            type: 'POST',
            data: formData,
            dataType: 'json',
            success: function (response) {
...
function tabledo(id) {
    ...
    tableDO = $("#table-do").DataTable({
        ...
        "ajax": {
            "url": base_url + 'pembayaran/detail_pembayaran/'+id,
            "type": "POST"
        },
        "lengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "All"]],
        "columns": [
...
function tablejl() {
    ...
    tableJL = $("#table-pelunasan").DataTable({
        ...
        "ajax": {
            "url": base_url + 'pembayaran/pelunasan_list/',
            "type": "POST"
        },
        "lengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "All"]],
        "columns": [
        ...
        "buttons": [
            ...
            },
            {
                ...
                action: function (e, dt, button, config) {
                    window.location.href = base_url + 'pembayaran/input_pelunasan'; // Ganti dengan URL tujuan
                }
            }
